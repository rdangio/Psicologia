...
const classCard =
  "bg-c-turquoise-2 pb-0 pt-1 px-1 rounded-3xl overflow-hidden shadow-inner shadow-black border-c-turquoise-5 border-1 shadow-xl shadow-gray-600"; // Estilização da borda e sombra do card
...
export const dataValue = [
  {
    ...
    classCard: `${classCard} sm:col-span-6 col-span-1`,
    classTitle,
    classText,
  },
  {
  ...
  },
  {
    ...
    title: "Valores",
    classCard: `${classCard}   col-span-1 sm:col-span-12`,
    classTitle,
