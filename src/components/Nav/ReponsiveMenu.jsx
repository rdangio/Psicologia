    ...
    <CentralizedContainer>
      <AnimatePresence mode="wait">
        {open && (
          ...
          >
            <div className="-inset-7 ml-[8rem] sm:ml-[20rem] mr-[1rem] mt-2 rounded-3xl rounded-tr-none bg-c-turquoise-5 py-5 text-fs-h6 font-semibold uppercase text-c-turquoise-1 sm:mt-8 sm:text-fs-h5">
